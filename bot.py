...
from fsub import get_fsub # Importing separate FSub file
...
async def admin_links(client, message):
    if "t.me/" in message.text:
        ...
        if not hasattr(client, "temp_id"):
            ...
            await message.reply_text("✅ First Link Saved! Send Last Link.")
        else:
